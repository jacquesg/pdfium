...
describe('PDFiumDocumentBuilder', () => {
  ...
  test('addRectangle returns this for chaining', () => {
    using builder = pdfium.createDocument();
    const page = builder.addPage();
  ...
  test('generateContent returns this for chaining', () => {
    using builder = pdfium.createDocument();
    const page = builder.addPage();
  ...
  test('methods can be chained together', async () => {
    ...
    page.addText('Hello', 100, 700, font, 24).addRectangle(50, 50, 512, 692).generateContent();
  ...
  test('page builder should throw on addRectangle after dispose', () => {
    using builder = pdfium.createDocument();
  ...
  test('page builder should throw on addText after dispose', () => {
    using builder = pdfium.createDocument();
    const font = builder.loadStandardFont('Helvetica');
    const page = builder.addPage({ width: 100, height: 100 });
    page.dispose();
  ...
  test('page builder should throw on generateContent after dispose', () => {
    using builder = pdfium.createDocument();
    const page = builder.addPage({ width: 100, height: 100 });
    page.dispose();
  ...
  test('disposing document builder should dispose its page builders', () => {
    const builder = pdfium.createDocument();
    const page = builder.addPage({ width: 100, height: 100 });
  ...
  test('INTERNAL access on builder provides handle', () => {
    using builder = pdfium.createDocument();
  ...
  test('INTERNAL access throws on disposed builder', () => {
    const builder = pdfium.createDocument();
    builder.dispose();
    expect(() => builder[INTERNAL]).toThrow();
  });

  test('addRectangle throws for invalid dimensions', () => {
    using builder = pdfium.createDocument();
    const page = builder.addPage();
  ...
  test('addText throws for invalid font size', () => {
    using builder = pdfium.createDocument();
    const font = builder.loadStandardFont('Helvetica');
    const page = builder.addPage();
  ...
  test('complex chaining preserves page reference', () => {
    using builder = pdfium.createDocument();
    const font = builder.loadStandardFont('Helvetica');
    const page = builder.addPage();
  ...
  test('multiple pages can be built independently', async () => {
    ...
    page1.addText('Page 1', 100, 700, font, 24).generateContent();

    const page2 = builder.addPage();
    page2.addText('Page 2', 100, 700, font, 24).generateContent();

    const page3 = builder.addPage();
    page3.addRectangle(50, 50, 500, 700).generateContent();
  ...
  test('deletePage throws for non-integer index', () => {
    using builder = pdfium.createDocument();
    builder.addPage();
  ...
  test('deletePage works correctly', () => {
    using builder = pdfium.createDocument();
    builder.addPage();
    builder.addPage();
    builder.addPage();
  ...
  test('addPage with all standard fonts', () => {
    using builder = pdfium.createDocument();
    const page = builder.addPage();
  ...
  test('addRectangle with both fill and stroke', () => {
    using builder = pdfium.createDocument();
    const page = builder.addPage();
  ...
  test('addRectangle with only stroke (no fill)', () => {
    using builder = pdfium.createDocument();
    const page = builder.addPage();
  ...
  test('addText with single character', () => {
    using builder = pdfium.createDocument();
    const font = builder.loadStandardFont('Helvetica');
    const page = builder.addPage();
