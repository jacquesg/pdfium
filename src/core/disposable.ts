...
/**
 * Shared base for disposable resource management.
 *
 * Contains constructor, disposal tracking, FinalizationRegistry integration,
 * and the ensureNotDisposed guard. Subclasses add the disposal protocol.
 */
abstract class DisposableBase {
  ...
  /**
   * Mark this resource as disposed and unregister from FinalizationRegistry.
   */
 ...
 * ```
 */
export abstract class Disposable extends DisposableBase implements globalThis.Disposable {
  /**
